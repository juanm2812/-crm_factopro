...
CREATE TABLE IF NOT EXISTS `event_tracker` (
  ...
  `status` enum('new','read') COLLATE utf8_unicode_ci DEFAULT 'new',
...
CREATE TABLE IF NOT EXISTS `invoices` (
  ...
  `ticket_anulacion` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `motivo_anulacion` text COLLATE utf8mb3_unicode_ci,
  `fecha_anulacion` datetime DEFAULT NULL,
  `respuesta_anulacion` text COLLATE utf8mb3_unicode_ci,
  `external_id_anulacion` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `documento` char(2) COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '',
  `numero_doc` varchar(255) COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '',
  `serie_doc` varchar(255) COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `status` (`status`),
...
CREATE TABLE IF NOT EXISTS `notification_settings` (
  ...
  `notify_to_team` text COLLATE utf8_unicode_ci NOT NULL,
  `notify_to_team_members` text COLLATE utf8_unicode_ci NOT NULL,
  `notify_to_terms` text COLLATE utf8_unicode_ci NOT NULL,
  `sort` int NOT NULL,
  `deleted` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `event` (`event`)
...
CREATE TABLE IF NOT EXISTS `tasks` (
  ...
  `lead_id` int NOT NULL DEFAULT '0',
  `client_id` int NOT NULL DEFAULT '0',
  `context` enum('project','client','lead','invoice','estimate','order','contract','proposal','subscription','ticket','expense','general') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'general',
  `created_by` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `status_id` (`status_id`),
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `client_permissions` text COLLATE utf8_unicode_ci,
  `deleted` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
